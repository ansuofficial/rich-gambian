    ...
    return (
      ...
      >
        <div
          ...
          className="box-border px-12 py-10"
        >
        ...
        <div className="box-border flex flex-1 flex-col px-12 py-10">
          <div className="mb-8 grid grid-cols-2 gap-6">
            <div className="min-w-0">
              ...
              <p
                ...
                className="truncate font-mono text-4xl font-bold"
              >
          ...
          <div
            ...
            className="mb-6 h-px w-full shrink-0"
          />
          ...
          <div
            ...
            className="mt-8 box-border w-full border-t pt-6 text-center"
          >
            ...
            <p
              style={{ color: c.accentRed }}
              className="mt-1 break-all px-4 text-base font-semibold"
            >
